    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm">
          ...
          <div><span className="text-muted-foreground">{t.nav.admin}: </span>{session?.pool || "—"}</div>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <span className="text-muted-foreground">URL: </span>{process.env.NEXT_PUBLIC_API_URL || "http://localhost:8765"}
        </CardContent>
      </Card>
    </div>
  )
